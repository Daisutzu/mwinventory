...
final List<Product> telefoniaCatalog = [
  ...
  // --- iPhone 18 Pro / Pro Max: prevendita, EAN non ancora noto -------
  // Codice PIM = "CODICE PRODOTTO" del foglio prevendita; il codice
  // "Codice Prevendita" (temporaneo, solo per il periodo di lancio) resta
  // in preorderCode come riferimento incrociato per lo staff.
  Product(
    id: 't150',
    name: 'iPhone 18 Pro',
    brand: 'Apple',
    ...
    variants: [
      ProductVariant(storage: '256GB', color: 'GL', code: '594897', preorderCode: '499516'),
      ProductVariant(storage: '256GB', color: 'BG', code: '594896', preorderCode: '499517'),
      ProductVariant(storage: '256GB', color: 'SV', code: '594895', preorderCode: '499518'),
      ProductVariant(storage: '256GB', color: 'BK', code: '594894', preorderCode: '499520'),
      ProductVariant(storage: '512GB', color: 'GL', code: '594901', preorderCode: '499505'),
      ProductVariant(storage: '512GB', color: 'BG', code: '594900', preorderCode: '499506'),
      ProductVariant(storage: '512GB', color: 'SV', code: '594899', preorderCode: '499513'),
      ProductVariant(storage: '512GB', color: 'BK', code: '594898', preorderCode: '499515'),
      ProductVariant(storage: '1TB', color: 'GL', code: '594916', preorderCode: '499500'),
      ProductVariant(storage: '1TB', color: 'BG', code: '594915', preorderCode: '499501'),
      ProductVariant(storage: '1TB', color: 'SV', code: '594914', preorderCode: '499503'),
      ProductVariant(storage: '1TB', color: 'BK', code: '594912', preorderCode: '499504'),
      ProductVariant(storage: '2TB', color: 'GL', code: '594921', preorderCode: '499495'),
      ProductVariant(storage: '2TB', color: 'BG', code: '594920', preorderCode: '499496'),
      ProductVariant(storage: '2TB', color: 'SV', code: '594918', preorderCode: '499498'),
      ProductVariant(storage: '2TB', color: 'BK', code: '594917', preorderCode: '499499'),
    ],
  ),
  Product(
    id: 't151',
    ...
    brand: 'Apple',
    category: 'Telefonia',
    imagePath: 'assets/products/appleiphone18promax.png',
    variants: [
      ProductVariant(storage: '256GB', color: 'GL', code: '594925', preorderCode: '499489'),
      ProductVariant(storage: '256GB', color: 'BG', code: '594924', preorderCode: '499490'),
      ProductVariant(storage: '256GB', color: 'SV', code: '594923', preorderCode: '499491'),
      ProductVariant(storage: '256GB', color: 'BK', code: '594922', preorderCode: '499492'),
      ProductVariant(storage: '512GB', color: 'GL', code: '594933', preorderCode: '499485'),
      ProductVariant(storage: '512GB', color: 'BG', code: '594932', preorderCode: '499486'),
      ProductVariant(storage: '512GB', color: 'SV', code: '594931', preorderCode: '499487'),
      ProductVariant(storage: '512GB', color: 'BK', code: '594926', preorderCode: '499488'),
      ProductVariant(storage: '1TB', color: 'GL', code: '594937', preorderCode: '499480'),
      ProductVariant(storage: '1TB', color: 'BG', code: '594936', preorderCode: '499481'),
      ProductVariant(storage: '1TB', color: 'SV', code: '594935', preorderCode: '499482'),
      ProductVariant(storage: '1TB', color: 'BK', code: '594934', preorderCode: '499484'),
      ProductVariant(storage: '2TB', color: 'GL', code: '596068', preorderCode: '499472'),
      ProductVariant(storage: '2TB', color: 'BG', code: '596065', preorderCode: '499473'),
      ProductVariant(storage: '2TB', color: 'SV', code: '594939', preorderCode: '499474'),
      ProductVariant(storage: '2TB', color: 'BK', code: '594938', preorderCode: '499475'),
    ],
  ),
];
